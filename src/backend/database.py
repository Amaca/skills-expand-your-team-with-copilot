...
initial_activities = {
    ...
    "Manga Maniacs": {
        "description": "Dive into epic adventures with ninja warriors, magical girl transformations, and legendary battles! Discover the power of friendship, unleash your inner hero, and join fellow otaku in exploring the amazing world of Japanese manga!",
